...
public class DaftarActivity extends Activity {
    ...
    private com.example.buku_kas_nusantara.User user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new com.example.buku_kas_nusantara.DBHelper(this);
        user = new com.example.buku_kas_nusantara.User();
