...
public class TambahPemasukanActivity extends AppCompatActivity {
    ...
    private com.example.buku_kas_nusantara.Cashflow cashflow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cashflow = new com.example.buku_kas_nusantara.Cashflow();
        ...
        kalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(com.example.buku_kas_nusantara.TambahPemasukanActivity.this, date, myCalendar
