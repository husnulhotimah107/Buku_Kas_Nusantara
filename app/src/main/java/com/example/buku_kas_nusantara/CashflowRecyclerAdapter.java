...
public class CashflowRecyclerAdapter extends RecyclerView.Adapter<com.example.buku_kas_nusantara.CashflowRecyclerAdapter.CashflowViewHolder> {
    private List<com.example.buku_kas_nusantara.Cashflow> listCashflow;

    public CashflowRecyclerAdapter(List<com.example.buku_kas_nusantara.Cashflow> listCashflow) {
    ...
    public CashflowViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_item_cash_flow, parent, false);
    ...
    public int getItemCount() {
        Log.v(com.example.buku_kas_nusantara.CashflowRecyclerAdapter.class.getSimpleName(),""+listCashflow.size());
