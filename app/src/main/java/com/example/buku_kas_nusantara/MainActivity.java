...
import com.example.buku_kas_nusantara.CashFlowActivity;
import com.example.buku_kas_nusantara.PengaturanActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void toIncome(View v){
        Intent intent = new Intent(getApplicationContext(), TambahPemasukanActivity.class);
        intent.putExtra("username", username);
        startActivity(intent);
        finish();
    }
    public void toOutcome(View v){
        Intent intent = new Intent(getApplicationContext(), com.example.buku_kas_nusantara.TambahPengeluaranActivity.class);
        intent.putExtra("username", username);
        startActivity(intent);
        finish();
    }
